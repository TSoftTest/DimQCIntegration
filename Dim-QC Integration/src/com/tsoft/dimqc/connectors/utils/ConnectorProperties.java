...
public class ConnectorProperties {
	...
	private ConnectorProperties() {
		/*
		 * Se verifica si existe variable de entorno para buscar el archivo de configuracion.
		 */
		...
		try{
			...
			nuevoPath = br.readLine();  // SI NO RECONOCIO LA VARIABLE O NO ESTA, LA LINEA DEVUELVE: %QCDIM_CONF%
	...
	/**
	 * 
	 * @return La diferencia en minutos entre la fecha de auditoria y la de sincronizacion para considerar desactualizado un request 
	 */
	...
	/**
	 * 
	 * @return La propiedad que me indica si QC prevalece sobre Dimensions o al reves.
	 */
	...
	/**
	 * 
	 * @return La cantidad maxima de caracteres que puede contener un campo en Dimensions.
	 */
	...
	/**Devuelve la cantidad maxima de campos comentarios (para los campos multiples).
	 * @return 
	 */
	...
	/**Devuelve el comentario para indicar que se ha superado la maxima cantidad de campos multiples posibles.
	 * @return 
	 */
	...
	public String getQcDataBasePass() {
		//Se comenta porque en el banco todavia no esta la clave encriptada y muestra un supuesto error al intentar desencriptar
		/*try{
			if (instance.getProperty("rutaArchivoKeyBaseQc") != null && instance.getProperty("rutaArchivoHashBaseQc") != null){
				return DesencriptadorPassword.obtenerPassword(instance.getProperty("rutaArchivoKeyBaseQc"), instance.getProperty("rutaArchivoHashBaseQc"));
			}
		} catch (Exception e) {
	...
	/**
	 * 
	 * @return si se quiere o no que se logue el/los query/ies que se ejecutan para cada aplicacion (SI/NO).
	 */
